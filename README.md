...
>> This implementation is described in Section 8.7 (A Storage Allocator)  
...
>> We maintain a fixed size array where each index represents a bin  
>> Each bin points to a NULL terminitaed linked list  
